from pyhton_OOP.classes_and_objects.project3.user import User


class Library:
    def __init__(self):
        self.user_records = []
        self.books_available = {}   # keeps {key:(author) and list of strings
        self.rented_books = {}      # keeps ({usernames: {book names: days to return}})
