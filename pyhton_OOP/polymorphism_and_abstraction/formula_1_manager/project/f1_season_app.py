# from pyhton_OOP.polymorphism_and_abstraction.formula_1_manager.project.formula_teams.mercedes_team import MercedesTeam
# from pyhton_OOP.polymorphism_and_abstraction.formula_1_manager.project.formula_teams.red_bull_team import RedBullTeam
...
class F1SeasonApp:
    ...
    def new_race_results(self, race_name: str, red_bull_pos: int, mercedes_pos: int):
        ...
        return f"Red Bull: {red_bul_revenue}. Mercedes: {mercedes_revenue}." \
